...
num_points = st.sidebar.slider("Počet bodů", min_value=3, max_value=100, value=10)
...
if st.button("Exportovat do PDF"):
    ...
    pdf.cell(200, 10, txt=f"Střed: ({x_center}, {y_center})", ln=True)
    ...
    pdf.cell(200, 10, txt="Autor: Vaše jméno, vas@email.cz", ln=True)
